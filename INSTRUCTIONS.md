...
You can see the latest releases in the Github repository at https://github.com/OurActivities/shower/releases
...
```
@ouractivities/shower
```

Or go directly to https://www.npmjs.com/package/@ouractivities/shower

To install the node module package use the following:

```
$ npm i @ouractivities/shower
```
